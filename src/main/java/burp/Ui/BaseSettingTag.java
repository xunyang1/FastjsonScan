...
public class BaseSettingTag {
    ...
    private JCheckBox isStartdelayExtensionBox;
    ...
    private void input3_4(JPanel baseSetting, GridBagConstraints c) {
        this.isStartdelayExtensionBox = new JCheckBox("延迟探测扩展-启动", this.yamlReader.getBoolean("application.DelayExtension.config.isStart"));
        this.isStartdelayExtensionBox.setFont(new Font("Serif", Font.PLAIN, this.isStartdelayExtensionBox.getFont().getSize()));
        c.insets = new Insets(5, 5, 5, 5);
        c.gridx = 0;
        c.gridy = 12;
        baseSetting.add(this.isStartdelayExtensionBox, c);
    }
    ...
    public Boolean isStartdelayExtension() {
        return this.isStartdelayExtensionBox.isSelected();
    }
}